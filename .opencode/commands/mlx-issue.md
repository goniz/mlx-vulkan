---
description: Read and address a GitHub issue
---

Read the GitHub issue number $ARGUMENTS from the goniz/mlx-vulkan repository using the gh cli tool: `gh issue view $ARGUMENTS --repo goniz/mlx-vulkan`
