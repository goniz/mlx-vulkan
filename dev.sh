...
disable_mpi_for_single_process_benchmark() {
    # mlx_lm.benchmark initializes distributed unconditionally. On hosts with
    # OpenMPI installed, that can underdrive Vulkan decode even at world size 1.
    # Point MLX at a non-library unless the caller explicitly requested MPI.
